...
def register_default_keys():
    ...
    register_normal_key(ord('p'),   commands.paste_item_original_subcal)
    register_normal_key(ord('P'),   commands.paste_item_selected_subcal)
...
def register_default_commands():
    ...
    register_command("yank",        commands.yank_item)
    register_command("delete",      commands.delete_item)
    register_command("paste",       commands.paste_item_original_subcal)
    register_command("paste!",      commands.paste_item_selected_subcal)
